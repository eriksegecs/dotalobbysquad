        ...
        <nav id="menu" className="z-50 sticky lg:top-0 w-full flex ss:flex-wrap justify-center p-4 bg-black border border-b-yellow-200 border-x-transparent text-white">
            ...
            <div className={`ss:w-full w-auto ${isMenuOpen ? 'block' : 'ss:hidden'} flex lg:items-center justify-between`}>
                <div className="text-sm md:flex-grow items-center font-alt  flex-shrink-0">
                    <a href="/#title" className='block lg:inline-block lg:mt-0 text-white hover:text-yellow-400 mr-4'>Home</a>
                    ...
                    <a href="/catchphrases" className='block mt-4 lg:inline-block lg:mt-0 text-white hover:text-yellow-300 mr-4 lg:pl-4'>Bordões</a>
                    <a href="/rules" className='block mt-4 lg:inline-block lg:mt-0 text-yellow-300 hover:text-yellow-500 mr-4 lg:pl-4'>Regras</a>
                </div>
